...
import GeneralMaintenance from './GeneralMaintenance.svg';
...
import Oilcheck from './oilcheck.svg';
...
export const GeneralMaintenanceImage = (props: ISVGProps) => <GeneralMaintenance {...resolveSize(props)} />;
...
export const TractorImage = (props: ISVGProps) => <Tractor {...resolveSize(props)} />;
...
export const OilImage = (props: ISVGProps) => <Oil {...resolveSize(props)} />;
export const OilcheckImage = (props: ISVGProps) => <Oilcheck {...resolveSize(props)} />;
export const Product1Image = (props: ISVGProps) => <Product1 {...resolveSize(props)} />;
