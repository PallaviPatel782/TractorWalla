...
import Bagtimer from './bagtimer.svg';
...
import Emergencybell from './emergencybell.svg';
...
export const AllServicesIcon = (props: ISVGProps) => <AllServices {...resolveSize(props)} />;
export const BagtimerIcon = (props: ISVGProps) => <Bagtimer {...resolveSize(props)} />;
export const BellIcon = (props: ISVGProps) => <Bell {...resolveSize(props)} />;
export const BillIcon = (props: ISVGProps) => <Bill {...resolveSize(props)} />;
export const BookingIcon = (props: ISVGProps) => <Booking {...resolveSize(props)} />;
export const BuyIcon = (props: ISVGProps) => <Buy {...resolveSize(props)} />;
export const CameraIcon = (props: ISVGProps) => <Camera {...resolveSize(props)} />;
...
export const CurrentLocationIcon = (props: ISVGProps) => <CurrentLocation {...resolveSize(props)} />;
export const DeleteIcon = (props: ISVGProps) => <Delete {...resolveSize(props)} />;
export const DownloadIcon = (props: ISVGProps) => <Download {...resolveSize(props)} />;
export const EditIcon = (props: ISVGProps) => <Edit {...resolveSize(props)} />;
export const EmergencybellIcon = (props: ISVGProps) => <Emergencybell {...resolveSize(props)} />;
...
export const SearchIcon = (props: ISVGProps) => <Search {...resolveSize(props)} />;
export const ServiceIcon = (props: ISVGProps) => <Service {...resolveSize(props)} />;
export const SettingIcon = (props: ISVGProps) => <Setting {...resolveSize(props)} />;
export const ShareIcon = (props: ISVGProps) => <Share {...resolveSize(props)} />;
